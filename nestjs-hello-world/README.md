...
- **AI agent** [(read more)](/0%20—%20AI%20Agent) — [(deploy with one click)](https://app.zerops.io/recipes/nestjs-hello-world?environment=ai-agent)
- **Remote (CDE)** [(read more)](/1%20—%20Remote%20(CDE)) — [(deploy with one click)](https://app.zerops.io/recipes/nestjs-hello-world?environment=remote-cde)
- **Local** [(read more)](/Local) — [(deploy with one click)](https://app.zerops.io/recipes/nestjs-hello-world?environment=local)
- **Stage** [(read more)](/Stage) — [(deploy with one click)](https://app.zerops.io/recipes/nestjs-hello-world?environment=stage)
