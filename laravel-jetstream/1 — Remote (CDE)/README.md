...
This is a remote (CDE) environment for [Laravel Jetstream (info + deploy)](https://app.zerops.io/recipes/laravel-jetstream?environment=remote) recipe on [Zerops](https://zerops.io).
