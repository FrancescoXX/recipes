# Django — Local Environment
This is a local environment for [Django (info + deploy)](https://app.zerops.io/recipes/django?environment=local) recipe on [Zerops](https://zerops.io).
