# Django — AI Agent Environment
This is an AI agent environment for [Django (info + deploy)](https://app.zerops.io/recipes/django?environment=ai-agent) recipe on [Zerops](https://zerops.io).
