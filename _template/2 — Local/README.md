<!-- #ZEROPS_REMOVE_START# -->
# PLACEHOLDER_PRETTY_RECIPE_NAME — Local Environment
This is a local environment for [PLACEHOLDER_PRETTY_RECIPE_NAME (info + deploy)](https://app.zerops.io/recipes/PLACEHOLDER_RECIPE_DIRECTORY?environment=local) recipe on [Zerops](https://zerops.io).
<!-- #ZEROPS_REMOVE_END# -->
